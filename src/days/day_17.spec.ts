...
describe('day 17', function () {
    describe('part 2', function () {
        ...
        it.skip('should be able to split all the commands in to smaller lists smaller then 20', function () {
            ...
            const totalCommand = exampleCommand.split(',').map(x => x.charCodeAt(0));
